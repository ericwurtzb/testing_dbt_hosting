...
FROM dbt_dataset.orders as Orders
...
left join dbt_dataset.customers C on orders.USER_ID = C.ID ),
...
from dbt_dataset.customers C 
left join dbt_dataset.orders as Orders
